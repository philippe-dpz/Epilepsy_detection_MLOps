...
BASE_MODEL_PATH = os.getenv("MODEL_PATH", "/app/models")
BASE_METRICS_PATH = os.getenv("METRICS_PATH", "/app/metrics")

PROCESSED_X_TRAIN_PATH = os.path.join(BASE_DATA_PATH, "processed/X_train.npy")
PROCESSED_Y_TRAIN_PATH = os.path.join(BASE_DATA_PATH, "processed/Y_train.npy")
PROCESSED_X_TEST_PATH = os.path.join(BASE_DATA_PATH, "processed/X_test.npy")
PROCESSED_Y_TEST_PATH = os.path.join(BASE_DATA_PATH, "processed/Y_test.npy")
MODEL_SAVE_PATH = os.path.join(BASE_MODEL_PATH, "epilepsy_model.keras")
METRICS_SAVE_PATH = os.path.join(BASE_METRICS_PATH, "model_metrics.json")
